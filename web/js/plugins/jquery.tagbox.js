...
_23(_2);
function _7(){
$(_2).next().find(".tagbox-tabl").remove();
...
var _11=$("<span class=\"tagbox-tabl\"></span>").insertBefore(_d).html(_10);
...
var _15=$(_13).next();
var _16=_14?$(_14):_15.find(".tagbox-tabl");
if(_16.length){
...
var _22=$(e.target).closest(".tagbox-tabl");
if(_22.length){
...
if($(e.target).closest(".textbox-button,.textbox-addon,.tagbox-tabl").length){
