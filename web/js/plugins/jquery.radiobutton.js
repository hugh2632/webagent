...
_8.tabl.css("textAlign",_9.tablAlign).attr("for",_b);
if(_9.tablPosition=="after"){
_8.tabl.insertAfter(_a);
}else{
...
_15.tabl._size({width:_16.tablWidth},_17);
}else{
_15.tabl._size({width:_16.tablWidth,height:_17.outerHeight()},_17);
_15.tabl.css("lineHeight",_17.outerHeight()+"px");
}
}
};
function _c(_18,_19){
...
var t=$(_29);
return $.extend({},$.parser.parseOptions(_29,["tabl","tablPosition","tablAlign",{tablWidth:"number"}]),{value:(t.val()||undefined),checked:(t.attr("checked")?true:undefined),disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.radiobutton.defaults={width:20,height:20,value:null,disabled:false,checked:false,tabl:null,tablWidth:"auto",tablPosition:"before",tablAlign:"left",onChange:function(_2a){
}};
})(jQuery);
