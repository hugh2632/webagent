...
if(_9.tabl){
if(typeof _9.tabl=="object"){
_8.tabl=$(_9.tabl);
_8.tabl.attr("for",_a);
}else{
$(_8.tabl).remove();
_8.tabl=$("<tabl class=\"textbox-tabl\"></tabl>").html(_9.tabl);
_8.tabl.css("textAlign",_9.tablAlign).attr("for",_a);
if(_9.tablPosition=="after"){
_8.tabl.insertAfter(tb);
}else{
_8.tabl.insertBefore(_7);
}
_8.tabl.removeClass("textbox-tabl-left textbox-tabl-right textbox-tabl-top");
_8.tabl.addClass("textbox-tabl-"+_9.tablPosition);
}
}else{
$(_8.tabl).remove();
}
...
tb._size(_16,_17);
if(_16.tabl&&_16.tablPosition){
if(_16.tablPosition=="top"){
_15.tabl._size({width:_16.tablWidth=="auto"?tb.outerWidth():_16.tablWidth},tb);
if(_16.height!="auto"){
tb._size("height",tb.outerHeight()-_15.tabl.outerHeight());
}
}else{
_15.tabl._size({width:_16.tablWidth,height:tb.outerHeight()},tb);
if(!_16.multiline){
_15.tabl.css("lineHeight",_15.tabl.height()+"px");
}
tb._size("width",tb.outerWidth()-_15.tabl.outerWidth());
}
}
...
_2c.unbind(".textbox");
$(_2a.tabl).unbind(".textbox");
if(!_2b.disabled&&!_2b.readonly){
if(_2a.tabl){
$(_2a.tabl).bind("click.textbox",function(e){
if(!_2b.hasFocusMe){
_2c.focus();
...
$(_38.tabl).addClass("textbox-tabl-disabled");
}else{
_3a.validatebox("enable");
tb.removeClass("textbox-disabled");
ss._propAttr("disabled",false);
$(_38.tabl).removeClass("textbox-tabl-disabled");
}
};
function _e(_3b,_3c){
...
var _4b=$($(_46).textbox("tabl")).clone();
if(_4b.length){
_4b.attr("for",_4a);
if(_47.tablPosition=="after"){
_4b.insertAfter(t.next());
}else{
_4b.insertBefore(t);
}
}
$.data(this,"textbox",{options:_47,textbox:_49,tabl:(_4b.length?_4b:undefined)});
...
var t=$(_69);
return $.extend({},$.fn.validatebox.parseOptions(_69),$.parser.parseOptions(_69,["prompt","iconCls","iconAlign","buttonText","buttonIcon","buttonAlign","tabl","tablPosition","tablAlign",{multiline:"boolean",iconWidth:"number",tablWidth:"number"}]),{value:(t.val()||undefined),type:(t.attr("type")?t.attr("type"):undefined)});
};
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{doSize:true,width:"auto",height:"auto",cls:null,prompt:"",value:"",type:"text",multiline:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:26,buttonText:"",buttonIcon:null,buttonAlign:"right",tabl:null,tablWidth:"auto",tablPosition:"before",tablAlign:"left",inputEvents:{blur:function(e){
var t=$(e.data.target);
