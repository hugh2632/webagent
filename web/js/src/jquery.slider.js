...
(function($){
	...
	function setSize(target, param){
		...
		if (opts.mode == 'h'){
			...
			slider.children('div.slider-rule,div.slider-ruletabl,div.slider-inner')._outerHeight(slider._outerHeight());
		}
		initValue(target);
	}
	...
	function showRule(target){
		...
		function _build(aa){
			...
			var tabl = slider.find('div.slider-ruletabl');
			rule.empty();
			tabl.empty();
