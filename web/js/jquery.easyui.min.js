...
if(opts.tabl){
if(typeof opts.tabl=="object"){
_4f4.tabl=$(opts.tabl);
_4f4.tabl.attr("for",_4f6);
}else{
$(_4f4.tabl).remove();
_4f4.tabl=$("<tabl class=\"textbox-tabl\"></tabl>").html(opts.tabl);
_4f4.tabl.css("textAlign",opts.tablAlign).attr("for",_4f6);
if(opts.tablPosition=="after"){
_4f4.tabl.insertAfter(_4f5);
}else{
_4f4.tabl.insertBefore(_4f3);
}
_4f4.tabl.removeClass("textbox-tabl-left textbox-tabl-right textbox-tabl-top");
_4f4.tabl.addClass("textbox-tabl-"+opts.tablPosition);
}
}else{
$(_4f4.tabl).remove();
}
...
if(opts.tabl&&opts.tablPosition){
if(opts.tablPosition=="top"){
_4ff.tabl._size({width:opts.tablWidth},_500);
}else{
_4ff.tabl._size({width:opts.tablWidth,height:_500.outerHeight()},_500);
_4ff.tabl.css("lineHeight",_500.outerHeight()+"px");
}
}
};
...
var t=$(_50e);
return $.extend({},$.parser.parseOptions(_50e,["tabl","tablPosition","tablAlign",{tablWidth:"number"}]),{value:(t.val()||undefined),checked:(t.attr("checked")?true:undefined),disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.radiobutton.defaults={width:20,height:20,value:null,disabled:false,checked:false,tabl:null,tablWidth:"auto",tablPosition:"before",tablAlign:"left",onChange:function(_50f){
}};
})(jQuery);
(function($){
var _510=1;
...
if(typeof opts.tabl=="object"){
_515.tabl=$(opts.tabl);
_515.tabl.attr("for",_517);
}else{
$(_515.tabl).remove();
_515.tabl=$("<tabl class=\"textbox-tabl\"></tabl>").html(opts.tabl);
_515.tabl.css("textAlign",opts.tablAlign).attr("for",_517);
if(opts.tablPosition=="after"){
_515.tabl.insertAfter(_516);
}else{
_515.tabl.insertBefore(_514);
}
_515.tabl.removeClass("textbox-tabl-left textbox-tabl-right textbox-tabl-top");
_515.tabl.addClass("textbox-tabl-"+opts.tablPosition);
}
}else{
$(_515.tabl).remove();
}
...
if(opts.tabl&&opts.tablPosition){
if(opts.tablPosition=="top"){
_520.tabl._size({width:opts.tablWidth},_521);
}else{
_520.tabl._size({width:opts.tablWidth,height:_521.outerHeight()},_521);
_520.tabl.css("lineHeight",_521.outerHeight()+"px");
}
}
};
...
var t=$(_530);
return $.extend({},$.parser.parseOptions(_530,["tabl","tablPosition","tablAlign",{tablWidth:"number"}]),{value:(t.val()||undefined),checked:(t.attr("checked")?true:undefined),disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.checkbox.defaults={width:20,height:20,value:null,disabled:false,checked:false,tabl:null,tablWidth:"auto",tablPosition:"before",tablAlign:"left",onChange:function(_531){
}};
})(jQuery);
(function($){
function init(_532){
...
if(typeof opts.tabl=="object"){
_573.tabl=$(opts.tabl);
_573.tabl.attr("for",_574);
}else{
$(_573.tabl).remove();
_573.tabl=$("<tabl class=\"textbox-tabl\"></tabl>").html(opts.tabl);
_573.tabl.css("textAlign",opts.tablAlign).attr("for",_574);
if(opts.tablPosition=="after"){
_573.tabl.insertAfter(tb);
}else{
_573.tabl.insertBefore(_572);
}
_573.tabl.removeClass("textbox-tabl-left textbox-tabl-right textbox-tabl-top");
_573.tabl.addClass("textbox-tabl-"+opts.tablPosition);
}
}else{
$(_573.tabl).remove();
}
...
if(opts.tabl&&opts.tablPosition){
if(opts.tablPosition=="top"){
_57e.tabl._size({width:opts.tablWidth=="auto"?tb.outerWidth():opts.tablWidth},tb);
if(opts.height!="auto"){
tb._size("height",tb.outerHeight()-_57e.tabl.outerHeight());
}
}else{
_57e.tabl._size({width:opts.tablWidth,height:tb.outerHeight()},tb);
if(!opts.multiline){
_57e.tabl.css("lineHeight",_57e.tabl.height()+"px");
}
tb._size("width",tb.outerWidth()-_57e.tabl.outerWidth());
}
}
...
_592.unbind(".textbox");
$(_591.tabl).unbind(".textbox");
if(!opts.disabled&&!opts.readonly){
if(_591.tabl){
$(_591.tabl).bind("click.textbox",function(e){
if(!opts.hasFocusMe){
_592.focus();
...
$(_59a.tabl).addClass("textbox-tabl-disabled");
}else{
_59b.validatebox("enable");
tb.removeClass("textbox-disabled");
ss._propAttr("disabled",false);
$(_59a.tabl).removeClass("textbox-tabl-disabled");
}
};
...
var _5a6=$($(from).textbox("tabl")).clone();
if(_5a6.length){
_5a6.attr("for",_5a5);
if(opts.tablPosition=="after"){
...
$.data(this,"textbox",{options:opts,textbox:span,tabl:(_5a6.length?_5a6:undefined)});
...
var t=$(_5be);
return $.extend({},$.fn.validatebox.parseOptions(_5be),$.parser.parseOptions(_5be,["prompt","iconCls","iconAlign","buttonText","buttonIcon","buttonAlign","tabl","tablPosition","tablAlign",{multiline:"boolean",iconWidth:"number",tablWidth:"number"}]),{value:(t.val()||undefined),type:(t.attr("type")?t.attr("type"):undefined)});
};
...
if(btn.length){
$("<tabl class=\"filebox-tabl\" for=\""+opts.fileboxId+"\"></tabl>").appendTo(btn);
...
_c38(_c1d);
function _c21(){
$(_c1d).next().find(".tagbox-tabl").remove();
...
var _c29=$("<span class=\"tagbox-tabl\"></span>").insertBefore(_c26).html(text);
...
var span=$(_c2b).next();
var _c2d=_c2c?$(_c2c):span.find(".tagbox-tabl");
if(_c2d.length){
...
var _c37=$(e.target).closest(".tagbox-tabl");
if(_c37.length){
...
(function($){
function init(_ca3){
var _ca4=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-ruletabl\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_ca3);
var t=$(_ca3);
...
_caa.children("div.slider-rule,div.slider-ruletabl,div.slider-inner")._outerHeight(_caa._outerHeight());
}
_cab(_ca7);
};
function _cac(_cad){
...
var _cb1=_caf.find("div.slider-ruletabl");
rule.empty();
_cb1.empty();
for(var i=0;i<aa.length;i++){
